...
<head>
    ...
    <input type="button" value="click me" onclick="testCallText()">
  ...
  <script src="goSamples.js"></script>  <!-- this is only for the GoJS Samples framework -->
      <script src="enGeno.js"></script>
  <script src="goSamples.js"></script>  <!-- this is only for the GoJS Samples framework -->
      <script src="formControlTestText.js"></script>
...
//fileHandle = fso.CreateTextFile("excutTime.txt", true);

function readTextToObj(path){

   startTime = new Date().getTime();
    //var text = FileHelper.readStringFromFileAtPath (path);
        var text;
 text = FileHelper.readStringFromFileAtPath ( path );
    
 //text = FileHelper.readStringFromFileAtPath ( "10node/3lv/genogram-info (1).txt" );
 
      //  text = FileHelper.readStringFromFileAtPath ( "10node/3lv/genogram-info ("+path+").txt" );
 ...
 //text = FileHelper.readStringFromFileAtPath ( path );
   // console.log(text);
    ...
    myDiagram = new enGeno(data, "myDiagram");
    myDiagram.init();
...
function testCallText(){

    var path;
    
    for(var k=0;k<30;k++){
            path = 50+"node/"+7+"lv/genogram-info ("+((k%5)+1)+").txt";
                  readTextToObj(path);
            }
    ...
    for(var i=10;i<=50;i+=10){
        ...
        for(var j=3;j<=7;j+=2){
            ...
            //-----txtFile.push(i+"node/"+j+"lv"+"\r\n");
            txtFile+= "\r\n"+i+"node/"+j+"lv"+"\r\n";
           // console.log(i+"node/"+j+"lv"+"\r\n");
            //fileHandle.write(i+"node/"+j+"lv"+"\r\n");
            
            for(var k=0;k<15;k++){
            path = i+"node/"+j+"lv/genogram-info ("+((k%5)+1)+").txt";
                if(i==10 && j==7 && (k%5)+1 >2){}
                else  readTextToObj(path);
            }
            if(i==10 && j==7){
                txtFile+= "\r\n"+"Average = "+avgTime/6+"\r\n";
                //txtFile+= avgTime/6+"\r\n";
    ...
    for(var i=10;i<=50;i+=10){
        ...
        for(var j=3;j<=7;j+=2){
           ...
           // console.log(i+"node/"+j+"lv"+"\r\n");
            ...
            for(var k=0;k<15;k++){
            path = i+"node/"+j+"lv/6Attr/genogram-info ("+((k%5)+1)+").txt";
                if(i==10 && j==7 && (k%5)+1 >2){}
                else  readTextToObj(path);
            }
            if(i==10 && j==7){
    ...
    for(var i=10;i<=50;i+=10){
        ...
        for(var j=3;j<=7;j+=2){
           ...
           // console.log(i+"node/"+j+"lv"+"\r\n");
            ...
            for(var k=0;k<15;k++){
            path = i+"node/"+j+"lv/12Attr/genogram-info ("+((k%5)+1)+").txt";
                if(i==10 && j==7 && (k%5)+1 >2){}
                else  readTextToObj(path);
            }
            if(i==10 && j==7){
    ...
    for(var i=10;i<=50;i+=10){
        ...
        for(var j=3;j<=7;j+=2){
           ...
           // console.log(i+"node/"+j+"lv"+"\r\n");
            ...
            for(var k=0;k<15;k++){
            path = i+"node/"+j+"lv/MAttr/genogram-info ("+((k%5)+1)+").txt";
                if(i==10 && j==7 && (k%5)+1 >2){}
                else  readTextToObj(path);
            }
            if(i==10 && j==7){
    ...
    for(var j=3;j<=7;j+=2){
        ...
        txtFile+="*************** 100 node Mix Attribute **************"+"\r\n";
    ...
    */
    ...
    Arrtxt.push(txtFile);
    var file=null;
    var data  = new File(Arrtxt, {type: 'plain/text'});
   ...
   if (file !== null) {
    ...
    /*
    for(var j=3;j<=7;j+=2){
            console.log("10node/"+j+"lv");
            for(var k=1;k<=5;k++){
            path = "10node/"+j+"lv/genogram-info ("+k+").txt";
                 readTextToObj(path);
            }
        }
    */
    // readTextToObj('10node/3lv/genogram-info (2).txt');
